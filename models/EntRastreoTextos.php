...
class EntRastreoTextos extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_elemento_texto', 'id_palabra_clave', 'txt_rastreo_texto', 'num_sentimiento_texto', 'num_magnitud_texto'], 'required'],
            [['id_elemento_texto', 'id_palabra_clave'], 'integer'],
            [['txt_rastreo_texto'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'txt_rastreo_texto' => 'Txt Rastreo Texto',
